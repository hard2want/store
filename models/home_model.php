...
$strSQL = "SELECT * FROM cis282final.users u ORDER BY u.user_Id "; // WHERE u.user_id = $userId
...
$userList = mysqli_fetch_all($result, MYSQLI_ASSOC); // you will rename your variable for each specific query
