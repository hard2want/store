...
<head>
    ...
    <?php
        require('models/edit_cohorts_model.php');
    ?>



	<title>CIS 282 Final | Edit Cohort</title>
</head>
    ...
    <body>
        ...
        <form action="models/edit_cohorts_model.php" method="POST">
            ...
            <label for="inputEmail3" class="col-sm-2 col-form-label">Term ID</label>
                <div class="col-sm-10">
                <input type="text" class="form-control" name='term_id' value="<?php echo $term_id; ?>">
                </div>
            </div>
            ...
            <label for="inputEmail3" class="col-sm-2 col-form-label">Time ID</label>
                <div class="col-sm-10">
                <input type="text" class="form-control" name='time_id' value="<?php echo $time_id; ?>">
                </div>
            </div>
        ...
        <a href="cohorts.php">Back to Cohorts</a>
