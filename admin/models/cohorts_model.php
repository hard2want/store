...
$strSQL = "SELECT * FROM cis282final.cohorts c ORDER BY c.cohort_Id "; // WHERE u.user_id = $userId
...
$cohortList = mysqli_fetch_all($result, MYSQLI_ASSOC); // you will rename your variable for each specific query
